...
To install the unreal environment, you can run the installer.  Please ensure that GOAL and Unreal Tournament have been installed. For UT3 make sure you install the UT3Patch4 and the UT3TitanPack otherwise
...
The run scripts for an UT3 server can be found in the \PVerb{Programs\Unreal Tournament 3} directory.
...
\begin{verbatim}
ut3.exe server CTF-GOALTest?game=GameBotsUT3.GBCTFGame?bIsDedicated=True?bIsLanMatch=True?bUsesStats=False?TimeLimit=99999
\end{verbatim}
...
There are also three maps for UT3. TODO: Add the maps. And a testmap CTF-GOALTest, a simple small map with all the items, powerups and weapons useful for testing.
...
Type & Send on change\\
Syntax & \verb|UT2004: status(<Health>, <Armour>, <Adrenaline>, <Combo>)|\\
& \verb|UT3: status(<Health>, <Armour>, <Adrenaline>, <Combo>)|\\
Parameters & 
