...
A dedicated server can be started using the UnrealOS execution environment (\textsc{ucc}) from the command prompt. The ucc is located in the \PVerb{Unreal Tournament 2004\System} directory. 
...
%TODO: Update with UT3 item types
